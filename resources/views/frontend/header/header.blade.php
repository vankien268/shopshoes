                        ...
                        <div class="col-md-7 col-md-offset-3 col-sm-9 hidden-xs">
                            ...
                            <div class="site-option">
                                ...
                                <ul>
                                    ...
                                    <li class="currency"><a href="#">Tài khoản <i class="fa fa-angle-down"></i> </a>
                                        <ul class="sub-site-option" style="width: 180px;">
                                            <li><a href="{{ route('form.login.home') }} ">Đăng nhập</a></li>
                                            <li><a href="{{ route('show.register.home') }} ">Đăng ký</a></li>
                                        </ul>
                                    </li>
                                        @endif
                                    @else
                                     <li class="language"><a href="#">Xin chào {{ Auth::guard('web')->user()->name }} !</a>
                                       
                                    </li>
                                    <li class="language"><a href="{{ route('client.logout') }}">Đăng xuất!</a>
